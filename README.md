...
+ 2014.11.19 - 完善职业加成表，新增覆盖率类Buff，添加易伤类buff，添加阵法数据，添加技能附魔名称，添加各职业奇穴方案名称，撰写算法变量与公开函数一览表，修改完善部分函数和计算，感谢淡淡稻花香提供BUFF整理数据。
...
+ 2014.11.23 - 新增配装器导入功能，添加言秀提供的冰心DPS预期计算方案与莫问KAP倍数法，新增新资料片小药
+ 明天开始可能近期会比较忙，只能周末抽空改改。
